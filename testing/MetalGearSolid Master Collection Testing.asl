/****************************************************/
/* Metal Gear Solid Autosplitter 2.4                */
/*                                                  */
/*                                                  */
...
/*                                                  */
/*  Originally Created by THE GOAT bmn              */
/*   <https://mgs.w00ty.com/>                       */
...
";
    ...
    F.ScanForGameInEmulator = (Func<Process, Process, ProcessModuleWow64Safe[], bool>)((g, mem, mod) => {
      ...
      if (memHeader != null) {
        ...
        // Master Collection uses a different header format (SLPM_862.XX instead of SLPM-86XXX)
        // Detect Integral specifically
        // if (vars.Platform == "MGS Master Collection (PC)") {
        //     if (strHeader.IndexOf("SLPM_862.48") != -1)
        //         productCode = "SLPM-86247";      // Integral
        //     else if (strHeader.IndexOf("SLUS_007.76") != -1)
        //         productCode = "SLUS-00594";      // English US
        //     else if (strHeader.IndexOf("SLES-01734") != -1)
        //         productCode = "SLES-01734"; // Spain
        //     else if (strHeader.IndexOf("SLES-01507") != -1)
        //         productCode = "SLES-01507"; // German
        //     else
        //         productCode = "SLPM-86111";      // JP
        // }
        // else {
...
update {
  ...
  // TEMP DEBUG: watch candidate PAL Key offsets, log only when something changes
  // if (MM.ContainsKey("ItemData")) {
  //   byte[] item = MM["ItemData"].Current as byte[];
  //   if (item != null && item.Length >= 64) {
  //     short v56 = BitConverter.ToInt16(item, 56);
  //     short v58 = BitConverter.ToInt16(item, 58);
  //     short v60 = BitConverter.ToInt16(item, 60);
  //     short v62 = BitConverter.ToInt16(item, 62);

  //     string snapshot = v56 + "|" + v58 + "|" + v60 + "|" + v62;
  //     if (snapshot != (V.LastPalDebug as string)) {
  //       F.Debug("PAL debug -> +56=" + v56 + " +58=" + v58 + " +60=" + v60 + " +62=" + v62
  //             + "  Location=" + vars.Location);
  //       V.LastPalDebug = snapshot;
  //     }
  //   }
  // }
